...
export default function PicTextSection() {
    ...
    useEffect(() => {
        ...
        setImageSize(getCalculatedValueByPercent(0, 20, percent, 0.9));
    }, [percent])
    ...
    return (
        ...
        >
            ...
            <Element className="flex flex-col items-center justify-center py-40" id="testid1">
                <img
                    ...
                    className="object-cover h-96 flex-1 mx-2"
                    style={{
                        transform: `matrix(${imageSize}, 0, 0, ${imageSize}, 0, ${-0.2 * percent})`,
                        opacity: imgOpacity
                    }}
                />
